// Complete Nigerian States with their Local Government Areas and major towns/cities
...
export const NIGERIAN_LOCATIONS: NigerianLocation[] = [
  {
    ...
    majorTowns: ["Aba", "Umuahia", "Ohafia", "Arochukwu", "Bende"]
  },
  {
    state: "Adamawa",
  ...
  },
  {
    ...
    majorTowns: ["Uyo", "Eket", "Ikot Ekpene", "Oron", "Abak"]
  },
  {
    state: "Anambra",
    ...
    majorTowns: ["Awka", "Onitsha", "Nnewi", "Ekwulobia", "Obosi", "Ozubulu"]
  },
  {
    state: "Bauchi",
    ...
    majorTowns: ["Bauchi", "Azare", "Misau", "Jama'are", "Ningi"]
  },
  {
    state: "Bayelsa",
    lgas: ["Brass", "Ekeremor", "Kolokuma/Opokuma", "Nembe", "Ogbia", "Sagbama", "Southern Ijaw", "Yenagoa"],
    majorTowns: ["Yenagoa", "Brass", "Nembe", "Ogbia", "Kaiama"]
  },
  {
    state: "Benue",
  ...
  },
  {
    ...
    majorTowns: ["Maiduguri", "Biu", "Bama", "Dikwa", "Gwoza"]
  },
  {
    state: "Cross River",
    ...
    majorTowns: ["Calabar", "Ikom", "Ogoja", "Obudu", "Ugep"]
  },
  {
    state: "Delta",
  ...
  },
  {
    ...
    majorTowns: ["Ado-Ekiti", "Ikere-Ekiti", "Ijero-Ekiti", "Ikole-Ekiti", "Omuo-Ekiti"]
  },
  {
    state: "Enugu",
    ...
    majorTowns: ["Enugu", "Nsukka", "Oji River", "Agbani", "Awgu"]
  },
  {
    state: "FCT Abuja",
    lgas: ["Abaji", "Abuja Municipal", "Bwari", "Gwagwalada", "Kuje", "Kwali"],
    majorTowns: ["Abuja", "Gwagwalada", "Kuje", "Kubwa", "Nyanya", "Maitama", "Wuse", "Garki"]
  },
  {
    state: "Gombe",
    lgas: ["Akko", "Balanga", "Billiri", "Dukku", "Funakaye", "Gombe", "Kaltungo", "Kwami", "Nafada", "Shongom", "Yamaltu/Deba"],
    majorTowns: ["Gombe", "Billiri", "Kaltungo", "Dukku", "Bajoga"]
  },
  {
    state: "Imo",
  ...
  },
  {
    ...
    majorTowns: ["Dutse", "Hadejia", "Gumel", "Kazaure", "Birnin Kudu"]
  },
  {
    state: "Kaduna",
    ...
    majorTowns: ["Kaduna", "Zaria", "Kafanchan", "Kachia", "Saminaka"]
  },
  {
    state: "Kano",
    ...
    majorTowns: ["Kano", "Wudil", "Gaya", "Rano", "Bichi"]
  },
  {
    state: "Katsina",
  ...
  },
  {
    ...
    majorTowns: ["Birnin Kebbi", "Argungu", "Yauri", "Zuru", "Jega"]
  },
  {
    state: "Kogi",
  ...
  },
  {
    ...
    majorTowns: ["Ilorin", "Offa", "Jebba", "Pategi", "Omu-Aran"]
  },
  {
    state: "Lagos",
    ...
    majorTowns: ["Lagos", "Ikeja", "Lekki", "Victoria Island", "Ikorodu", "Epe", "Badagry", "Ajah", "Yaba", "Surulere", "Festac", "Oshodi"]
  },
  {
    state: "Nasarawa",
    lgas: ["Akwanga", "Awe", "Doma", "Karu", "Keana", "Keffi", "Kokona", "Lafia", "Nasarawa", "Nasarawa Egon", "Obi", "Toto", "Wamba"],
    majorTowns: ["Lafia", "Keffi", "Akwanga", "Nasarawa", "Doma"]
  },
  {
    state: "Niger",
    ...
    majorTowns: ["Minna", "Bida", "Suleja", "Kontagora", "New Bussa"]
  },
  {
    state: "Ogun",
  ...
  },
  {
    ...
    majorTowns: ["Akure", "Ondo", "Owo", "Okitipupa", "Ikare-Akoko"]
  },
  {
    state: "Osun",
    ...
    majorTowns: ["Osogbo", "Ile-Ife", "Ilesa", "Ede", "Iwo"]
  },
  {
    state: "Oyo",
  ...
  },
  {
    ...
    majorTowns: ["Jos", "Bukuru", "Shendam", "Langtang", "Pankshin"]
  },
  {
    state: "Rivers",
    ...
    majorTowns: ["Port Harcourt", "Bonny", "Degema", "Bori", "Okrika"]
  },
  {
    state: "Sokoto",
  ...
  },
  {
    ...
    majorTowns: ["Damaturu", "Potiskum", "Nguru", "Gashua", "Geidam"]
  },
  {
    state: "Zamfara",
    ...
    majorTowns: ["Gusau", "Kaura Namoda", "Talata Mafara", "Anka", "Maru"]
  }
];
...
export const getAllLocations = (): string[] => {
  ...
  NIGERIAN_LOCATIONS.forEach(loc => {
    locations.push(loc.state);
    loc.lgas.forEach(lga => locations.push(`${lga}, ${loc.state}`));
    loc.majorTowns.forEach(town => {
      if (!locations.includes(`${town}, ${loc.state}`)) {
        locations.push(`${town}, ${loc.state}`);
      }
    });
  });
...
export const getStateLocations = (state: string): string[] => {
  const stateData = NIGERIAN_LOCATIONS.find(
  ...
  const locations = [
    stateData.state,
    ...stateData.lgas.map(lga => `${lga}, ${stateData.state}`),
    ...stateData.majorTowns.map(town => `${town}, ${stateData.state}`)
  ];
